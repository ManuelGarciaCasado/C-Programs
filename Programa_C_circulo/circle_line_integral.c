...
{
  FILE			*ufieldInput, *vfieldInput,*pfieldInput;
  unsigned char		someChar;
  unsigned char *pChar;
  int a,b,i,j,xnum,ynum;
  ...
  /*--------READ INPUT FILE------------*/
  ufieldInput = fopen(argv[1], "r");
  vfieldInput = fopen(argv[2], "r");
  pfieldInput = fopen(argv[3], "r");
