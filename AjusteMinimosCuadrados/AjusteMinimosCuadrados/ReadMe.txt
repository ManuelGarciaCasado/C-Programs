========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: AjusteMinimosCuadrados Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL AjusteMinimosCuadrados.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación AjusteMinimosCuadrados.


AjusteMinimosCuadrados.vcxproj
...
AjusteMinimosCuadrados.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado AjusteMinimosCuadrados.pch y un archivo de tipos precompilados llamado StdAfx.obj.
